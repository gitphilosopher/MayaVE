...
class Router:
    def __init__(self, speaker: Speaker):
        ...
        self._routes: dict = {
            # System — open_target merges the former separate open_app
            # (desktop apps) and open_website (websites) intents; the
            # skill itself resolves which the utterance meant.
            ...
            # Timers — set_timer now covers both a bare countdown and a
            # timer carrying a reminder message (former set_reminder);
            # timer.execute() itself tells the two apart from the wording.
            "set_timer":     timer,
            "cancel_timer":  timer,
            "timer_status":  timer,
            # Notepad — note_write merges the former note_create/
            # note_append; note_view merges the former note_read/
            # note_list/note_open. note_delete is unchanged.
            "note_write":    notepad,
            "note_view":     notepad,
            "note_delete":   notepad,
